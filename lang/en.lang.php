...
define('_gameserver_map_invalid','The Map contains invalid letters (a-z,A-Z,0-9._-) are allowed)');
define('_gameserver_parameter_invalid','The Parameters contain invalid letters (a-z,A-Z,0-9._ -) are allowed)');
